<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\geework\public/../application/panel\view\user\edit.html";i:1508919235;s:72:"D:\phpStudy\WWW\geework\public/../application/panel\view\common\top.html";i:1508919447;s:73:"D:\phpStudy\WWW\geework\public/../application/panel\view\common\left.html";i:1508812171;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>后台管理系统</title>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('lst'); ?>">员工管理</a>
                    </li>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="username" type="text" value="<?php echo $userres['username']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="password" type="password" value="<?php echo $userres['password']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="sex">
                                                    <option value="<?php echo $userres['sex']; ?>"><?php if($userres['sex'] == 1): ?>
                                                        男
                                                        <?php else: ?>
                                                        女
                                                        <?php endif; ?></option>
                                        ...
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">手机</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="phone" type="text" value="<?php echo $userres['phone']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">座机</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="tel" type="text" value="<?php echo $userres['tel']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">邮箱</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="mail" type="text" value="<?php echo $userres['mail']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="position">
                                                    <option value="<?php echo $userres['position']; ?>"><?php echo $userres['position']; ?></option>
                                                    <option value="">请选择职位</option>
                                                    <?php if(is_array($ptres) || $ptres instanceof \think\Collection || $ptres instanceof \think\Paginator): $i = 0; $__LIST__ = $ptres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <option value="<?php echo $vo['ptname']; ?>"><?php echo $vo['ptname']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <input <?php if($userres['state'] == 1): ?> checked="checked"<?php endif; ?> class="checkbox-slider colored-darkorange" name="state" type="checkbox">
