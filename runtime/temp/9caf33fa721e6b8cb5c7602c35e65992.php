<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\phpStudy\WWW\geework\public/../application/panel\view\position\edit.html";i:1508823546;s:72:"D:\phpStudy\WWW\geework\public/../application/panel\view\common\top.html";i:1508893340;s:73:"D:\phpStudy\WWW\geework\public/../application/panel\view\common\left.html";i:1508812171;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>后台管理系统</title>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('lst'); ?>">职位管理</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改职位</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <!--隐藏域当前的id-->
                        <input type="hidden" name="id" value="<?php echo $ptres['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">职位名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" name="ptname" type="text" value="<?php echo $ptres['ptname']; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
